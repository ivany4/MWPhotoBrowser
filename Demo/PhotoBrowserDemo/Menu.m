...
- (id <MWPhoto>)browser:(MWPhotoBrowser *)photoBrowser mediaItemAtIndex:(NSUInteger)index {
    if (index < _photos.count)
        return [_photos objectAtIndex:index];
    return nil;
}

- (id <MWPhoto>)browser:(MWPhotoBrowser *)photoBrowser thumbnailAtIndex:(NSUInteger)index {
